...
public:
    ...
    virtual Address& mutAddress() { return m_address; }
    virtual h256s& mutTopics() { return m_topics; }
    virtual bytes& mutData() { return m_data; }
...
Stream& operator>>(Stream& _stream, LogEntry& _logEntry)
{
    return _stream >> _logEntry.mutAddress() >> _logEntry.mutTopics() >> _logEntry.mutData();
}

template <class Stream, typename = std::enable_if_t<Stream::is_encoder_stream>>
Stream& operator<<(Stream& _stream, const LogEntry& _logEntry)
{
