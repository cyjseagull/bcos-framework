 ...
 * @file ScaleTransactionReceipt.h
 * @author: yujiechen
 * @date: 2021-03-18
 */
#pragma once
...
namespace protocol
{
class ScaleTransactionReceipt : public TransactionReceipt
{
public:
    ScaleTransactionReceipt(bcos::crypto::CryptoSuite::Ptr _cryptoSuite, bytes const& _receiptData);
    ScaleTransactionReceipt(bcos::crypto::CryptoSuite::Ptr _cryptoSuite, int32_t _version,
